...
import org.trams.hello.push.service.FingerPushService;

import net.sf.json.JSONException;
import net.sf.json.JSONObject;


public class FingerPushServiceImpl implements FingerPushService{
	Logger logger;
	String source = "";
	
	public FingerPushServiceImpl(){
		super();
		logger = Logger.getLogger("FingerpushDaoImpl");		
	}
	
	public FingerPushServiceImpl(String source){
		super();
		logger = Logger.getLogger("FingerpushDaoImpl");
		this.source  = source;
	}	
	...
	@Override
	public String sendAllDevice(FingerPush push)
	...
	@Override
	public String sendTargetPush(FingerPush push) 
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException {
		String jsonString  = "";
	...
	@Override
	public String sendTargetUnderMax(FingerPush push, ArrayList<Map<String, String>> paramList)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException {
	...
	@Override
	public String sendTargetMore(FingerPush push, ArrayList<String> userList, ArrayList<String> messList)
	...
	@Override
	public String sendTargetMore(FingerPush push, ArrayList<String> userList, ArrayList<String> messList, ArrayList<String> fileList)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException, JSONException {
	 ...
	 */
	@Override
	public String sendTargetMore(FingerPush push, ArrayList<Map<String, String>> paramList)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException, JSONException {
	...
	private String sendTargetMoreProc(FingerPush push, ArrayList<String> userList, ArrayList<String> messList, ArrayList<String> fileList, ArrayList<String> linkList, ArrayList<String> titleList) 
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException, JSONException {
	 ...
	 */
	private String sendTargetMoreProc(FingerPush push, ArrayList<String> userList, ArrayList<String> messList, ArrayList<String> fileList, ArrayList<String> linkList, ArrayList<String> titleList, ArrayList<String> hpList) 
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException, JSONException {
		String jsonString = "";
        // 파라미터 설정
        List <BasicNameValuePair> params = new ArrayList<BasicNameValuePair>(); 
	...
	// 발송 완료 처리
	public String sendFinish(FingerPush push)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException
	{
		String jsonString  = "";
	 ...
	 * @return
	 */
	private List <BasicNameValuePair> setParams(FingerPush push, List <BasicNameValuePair> params){
        params.add (new BasicNameValuePair("appkey",push.getAppKey()));								//  (필수)	
        params.add (new BasicNameValuePair("appsecret",push.getAppSecret()));						//  (필수)
        params.add (new BasicNameValuePair("customerkey",push.getCustomerKey()));				//  (필수)
	 ...
	 * @throws IOException
	 */
	private String sendTargetList(FingerPush push, ArrayList<String> targetList, ArrayList<String> messList)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException
	{
	 ...
	 * @throws IOException
	 */
	private String sendTargetList(FingerPush push, ArrayList<String> targetList, ArrayList<String> messList, ArrayList<String> hpList)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException
	{
	 ...
	 * @throws IOException
	 */
	private String sendTargetList(FingerPush push, ArrayList<String> targetList, ArrayList<String> messList, ArrayList<String> fileList, ArrayList<String> linkList, ArrayList<String> titleList, ArrayList<String> hpList)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException
	{
		String jsonString  = "";
	 ...
	 */
	@Override
	public String getRtTargetMess(FingerPush push, int pageNo)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException {
		String jsonString  = "";			// 서버로 발송 후 결과 메시지
	 ...
	 */
	@Override
	public String cnclPushMess(FingerPush push)
			throws NoSuchAlgorithmException, KeyManagementException, ClientProtocolException, IOException {
		String jsonString  = "";			// 서버로 발송 후 결과 메시지
