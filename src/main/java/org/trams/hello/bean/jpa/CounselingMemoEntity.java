...
/**
 * Persistent class for entity stored in table "counseling_memo"
 *
...
@Entity
@Table(name="counseling_memo", catalog="hello" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="CounselingMemoEntity.countAll", query="SELECT COUNT(x) FROM CounselingMemoEntity x" )
} )
@DynamicInsert
@DynamicUpdate
public class CounselingMemoEntity implements Serializable {
