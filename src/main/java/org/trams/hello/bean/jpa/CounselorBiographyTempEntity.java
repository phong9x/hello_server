...
/**
 * Persistent class for entity stored in table "counselor_biography_temp"
 *
...
@Entity
@Table(name="counselor_biography_temp", catalog="hello" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="CounselorBiographyTempEntity.countAll", query="SELECT COUNT(x) FROM CounselorBiographyTempEntity x" )
} )
@DynamicInsert
@DynamicUpdate
public class CounselorBiographyTempEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public CounselorBiographyTempEntity() {
		super();
    }
