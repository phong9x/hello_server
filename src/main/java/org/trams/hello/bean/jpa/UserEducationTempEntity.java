...
/**
 * Persistent class for entity stored in table "user_education_temp"
 *
...
@Entity
@Table(name="user_education_temp", catalog="hello" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="UserEducationTempEntity.countAll", query="SELECT COUNT(x) FROM UserEducationTempEntity x" )
} )
@DynamicInsert
@DynamicUpdate
public class UserEducationTempEntity implements Serializable {
    ...
    @Column(name="university", nullable=false, length=300)
    private String     university   ;

    @Column(name="counselor_temp_id")
    private Integer    counselorTempId ;

    @Column(name="faculty", nullable=false, length=300)
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public UserEducationTempEntity() {
		super();
    }
    ...
    //--- DATABASE MAPPING : university ( VARCHAR ) 
