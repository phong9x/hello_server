...
/**
 * Persistent class for entity stored in table "user_file"
 *
...
@Entity
@Table(name="user_file", catalog="hello" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="UserFileEntity.countAll", query="SELECT COUNT(x) FROM UserFileEntity x" )
} )
@DynamicInsert
@DynamicUpdate
