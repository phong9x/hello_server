...
public class LoginStaticsController extends AbstractController {
	...
	private static final String JSP_LIST   = "admin/statistics/login/list";
	 ...
	 * Default constructor
	 */
	public LoginStaticsController() {
		super(LoginStaticsController.class, MAIN_ENTITY_NAME );
	...
	public String user_chart(
			...
			Model model) {
		Date now = new Date();
		PageCustom<LoginStatistics> listPage = loginHistoryService.filterStatistics(s, page, Integer.MAX_VALUE);
