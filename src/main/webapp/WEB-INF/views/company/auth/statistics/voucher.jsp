          ...
          <div class="container">
            <div class="main-body-content member-page push-list">
              ...
              <div class="member-title-table">
                <div class="md-ct"><span class="title">상담권 사용 내역 :</span><span>${totalCount}건</span>
                  ...
                  <tbody>
					...
					<c:forEach items="${list}" var="l">
						<tr>
						  ...
						  <td>
						  	<p><fmt:formatDate value="${l.useVoucherDate}" pattern="yyyy-MM-dd"/></p>
		                    <p><fmt:formatDate value="${l.useVoucherDate}" pattern="HH:mm:ss"/></p>
						  </td>
              ...
              <!--.table-member-mng-->
				<div class="link-submit" style="margin-top: 0px !important; margin-bottom: 0px !important;">
                  <button type="submit" data-key="${keyword}" data-sub_company="${subCompany }" data-year_search="${yearSearch}" data-rs_order = "${rsOrder}"
                   class="btn green pull-right excelExport">엑셀 다운로드</button>
                </div>
              <!--.table-member-mng-->
...
<script type="text/javascript">
		$(document).ready(function() {
			$('#rs_order').on('change', function() {
				...
				window.location = "/company/auth/statistics/voucher?rs_order="+ orderType + "&year_search="+ year_search +"&sub_company="+ sub_company +"&keyword="+ keyword  ;
		...
		(function($) {
		   ...
		   $(document.body).on('click','.excelExport',function () {
					...
					window.open("/company/auth/statistics/voucher/export_excel?rs_order="+ rs_order + "&year_search="+ year_search +"&sub_company="+ sub_company +"&keyword="+ keyword,"_blank");
			});
		})(jQuery);
	</script>
