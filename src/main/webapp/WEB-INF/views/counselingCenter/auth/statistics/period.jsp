            	...
            	<div class="member-main-content">
		            <div class="tabbable-custom">
			            <ul class="nav nav-tabs">
		                    <li class="active"><a >기간별</a><jsp:text/></li>
		                    <li><a href="/counselingCenter/auth/statistics/week" >요일별</a><jsp:text/></li>
		                    <li><a href="/counselingCenter/auth/statistics/hour" >시간별</a><jsp:text/></li>
	                  	</ul>
		              <div class="">
		                    ...
		                    <div class="md-tab-content tabv2">
		                      <form class="search-from" method="get" >
		                        <div class="member-main-top border-full">
								  <tiles:insertTemplate template="/WEB-INF/views/counselingCenter/auth/common/searchDayWeekMonth.jspx" />
