//popup coin
 ...
 function ajax_paging_member(page){
  ...
  $('.next-slide-member#step1').click(function(event) {
	...
	$('.button-show-popup-push-form').click(function(event) {
	  	$("body").addClass("fade-none");
	})
	
	$('.closePopupPush').click(function(event) {
	  	$("body").removeClass("fade-none");
	})
...
$(document).ready(function(){
	$('#excelExportMindcheck').click(function() {
		console.log(11111111111111);
	      var tab_text="<table border='2px'><tr bgcolor='#87AFC6'>";
	      var textRange; var j=0;
	      tab = document.getElementById('statisticMindcheck'); // id of table
