...
$(document).ready(function() {
  ...
  (function($) {
   ...
   $('.checkall input#all').bind('click', function(){
      ...
      $(this).closest('.checkall').find('label input').attr('checked', status);
      $.uniform.update('.checkall label input');
    });
        ...
        series: [
          {
            ...
            // explodedRadius: 20,
            explodedSlices: [5],
            data: [['face', 65], ['google', 58], ['blog', 30],
                 ['map', 60]]
          }
        ]
    });
