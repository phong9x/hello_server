...
$(document).ready(function() {
  ...
  $(document.body).on('click', '.input-group-addon', function() {
    $('#popup-choiceDate').addClass('show-datepicker');
  });
  
  $(document.body).on('click', '.menu-right .right-content.style1 li', function() {
    $('.menu-right').addClass('show-submenu');
  });
  $(document.body).on('click', '.menu-right .close-right', function() {
