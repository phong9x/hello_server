! function(a) {
    a.fn.jalendar = function(e) {
        function t() {
            ...
            e.setFullYear(D, M, 0);
            var t = e.getDay() + C;
            v.find(".header h1").html(D + "년 " + " " + o[l.lang][M] + '<div class="total-bar"></div>'), 
            v.find(".day").html("&nbsp;").removeAttr("data-date").removeClass("this-month have-event disable-selecting");
            ...
            for (var r = 1; r <= S[M]; r++) {
                ...
                "dd-mm-yyyy" == l.dateType ? i = r + "-" + s + "-" + D : "mm-dd-yyyy" == l.dateType ? i = s + "-" + r + "-" + D : "yyyy-mm-dd" == l.dateType ? i = D + "-" + s + "-" + r : "yyyy-dd-mm" == l.dateType && (i = D + "-" + r + "-" + s), "linker" == l.type ? v.find(".day").eq(t - 1).addClass("this-month").attr("data-date", i).html('<span><a href="' + l.customUrl + i + '">' + r + "</a></span>") : v.find(".day").eq(t - 1).addClass("this-month").attr("data-date", i).html("<span>" + r + "</span>");
                var y = Math.round(new Date(D + "/" + M + "/" + r + " 00:00:00").getTime() / 1e3),
                    u = Math.round(new Date(m + "/" + p + "/" + h + " 00:00:00").getTime() / 1e3);
                1 == l.selectingBeforeToday && y > u && v.find(".day").eq(t - 1).addClass("disable-selecting"), 
                1 == l.selectingAfterToday && y < u && v.find(".day").eq(t - 1).addClass("disable-selecting"), 
                v.find(".days").attr("data-month", s).attr("data-year", D)
            }
        ...
        s.TR = new Array("Pzt", "Sal", "Çar", "Per", "Cum", "Cmt", "Pzr"), 
        s.ES = new Array("Lun", "Mar", "Mié", "Jue", "Vie", "Såb", "Dom"), 
        ...
        s.ZH = new Array("星期一", "星期二", "星期三", "星期四", "星期五", "星期六", "星期天"), 
        s.KR = new Array("일", "월", "화", "수", "목", "금", "토"), 
        s.HI = new Array("रविवार", "सोमवार", "मंगलवार", "बुधवार", "गुरुवार", "शुक्रवार", "शनिवार"), 
        ...
        o.DE = new Array("Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"), 
        o.FR = new Array("Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Aoút", "Septembre", "Octobre", "Novembre", "Décembre"), 
        o.IT = new Array("Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Guigno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"), 
        o.FIL = new Array("Enero", "Pebrero", "Marso", "Abril", "Mayo", "Hunyo", "Hulyo", "Agosto", "Setyembre", "Oktubre", "Nobyembre", "Disyembre"), 
        o.RU = new Array("Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"), 
        o.NL = new Array("januari", "februari", "maart", "april", "mei", "juni", "juli", "augustus", "september", "oktober", "november", "december"), 
        o.ZH = new Array("一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"), 
        o.KR = new Array("1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"), 
        o.HI = new Array("जनवरी", "फरवरी", "मार्च", "अप्रैल", "मई", "जून", "जुलाई", "अगस्त", "सितंबर", "अक्टूबर", "नवंबर", "दिसंबर"), 
        o.PT = new Array("Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"), 
        o.PL = new Array("styczen", "luty", "marzec", "kwiecien", "maj", "czerwiec", "lipiec", "sierpien", "wrzesien", "pazdziernik", "listopad", "grudzien"), 
        y.EN = "Event(s)", 
        y.TR = "Etkinlik", 
        y.ES = "Evento(s)", 
        y.DE = "Tätigkeit", 
        ...
        J[1].on("click", function() {
            ...
            function e(a) {
                ...
                a.addClass("first-range"), I.val(a.attr("data-date")), 
                E = v.find('[data-date="' + v.find(".first-range").attr("data-date") + '"]').index(), 
            ...
            function t(a) {
                a.addClass("last-range"), P.val(a.attr("data-date")), 
                F = v.find(".last-range").index(), 
                x = Number(v.find(".days").attr("data-month")), 
                L = Number(v.find(".days").attr("data-year"))
            }
            if ("selector" == l.type) return v.find("input.data1").val(a(this).data("date")), 
                a(this).parent().find(".selected").removeClass("selected"), 
                a(this).addClass("selected"), 
                v.parent().is(".jalendar-input") && (v.parent().find("input").removeClass("selected"), 
                    v.parent(".jalendar-input").find("input").val(a(this).data("date"))), null !== l.done && l.done.call(this), !1;
            if ("range" == l.type) {
            ...
            v.find(".events .event-single").remove(), r(), 
            "" === l.type && (v.find("input.data1").val(a(this).data("date")), 
                a(this).addClass("selected"), v.find(".add-event").find(".events-list").html(n.clone()), 
                v.parent().is(".jalendar-input") && v.parent(".jalendar-input").find("input").val(a(this).data("date")), 
                v.find(".events .event-single").length >= 0 && v.find(".events h3 span").html(v.find(".events .event-single").size()), 
                v.find(".add-event").addClass("selected").height(v.find(".add-event .events").height() + 59))
